function [log_mel_spec, freq_centers, frames, M, N] = log_mel_spectrogram(signal, fs, win_shift, win_length, freq_range, num_bands, band_factor)
...
M = 2.*round(win_shift./1000.*fs./2);
N = 2.*round(win_length./1000.*fs./2);
